...
public class AttachmentDownloadFromStory {
	...
	public static void main(String[] args) throws URISyntaxException, IOException {
		...
		String applicationName = "Universal Rally Data Extractor";
		String apiKey = "_YvorQJsTqigeeZVoazKaCjRoQWOYUTNlkmjmTAvME4";
		...
		String myWorkspace = "Workspace 1";
		String myProject = "Sample Project";

		// FormattedID of Existing Test Case to Query
		String existStoryFormattedID = "US11";       
        ...
        int attachmentsArrayNumber = attachmentsArray.size();
        System.out.println("Array Size is:" + attachmentsArrayNumber);

		// Take first attachment
       
        for (int a=0; a<attachmentsArrayNumber;a++)
        {
        JsonObject attachmentObject = attachmentsArray.get(a).getAsJsonObject();
		String attachmentRef = attachmentObject.get("_ref").getAsString();
		System.out.println("Attachment Ref is:" + attachmentRef);
	    ...
	    System.out.println("Attachment Ref is:" + attachmentName);
	    ...
	    System.out.println("AttachmentContent attachmentContentBase64String: " + attachmentContentBase64String);
        
		// Decode base64 string into bytes
		byte[] imageBytes = Base64.decodeBase64(attachmentContentBase64String);
        
		// Image output
		String imageFilePath = "/Users/Ganeshbabu/Desktop/";
